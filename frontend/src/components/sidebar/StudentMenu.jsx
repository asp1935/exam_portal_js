...
function StudentMenu() {
    ...
    const menuData = [
        ...
        { title: 'Center', items: [{ name: 'Add Center', path: '/add-center' }, { name: 'Center List', path: '/center-list' }, { name: 'Add Representative', path: '/add-representative' }, { name: 'Representative List', path: '/representative-list' }] },
